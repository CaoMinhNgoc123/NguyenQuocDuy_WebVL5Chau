...
<html lang="en">
   <head>
      ...
      <script src="https://vietnamtravel.net.vn/assets/desktop/js/frame_script.js"></script>
      <script>
         $(document).ready(function(){
             $('.buyProduct').on('click', function(e){
                 e.preventDefault();
                 var elementError =  $('.show-error-buy-product');
                 if($('input').hasClass('input-color')) {
                     var color = $('input[name="color"]:checked', '#formBuyProduct').val();
                     if(typeof color === "undefined") {
                         elementError.addClass('show-error');
                         elementError.children().text('vui lòng chọn màu');
                         return true;
                     }
                 }
                 if($('input').hasClass('input-size')) {
                     var size = $('input[name="size"]:checked', '#formBuyProduct').val();
                     if(typeof size === "undefined") {
                         elementError.addClass('show-error');
                         elementError.children().text('vui lòng chọn size');
                         return true;
                     }
                 }
                 var input = $("#formBuyProduct").serializeArray();
                 var jsonInput = JSON.stringify(input);
                 var product_id = $(this).attr('product_id');
         
                 $.ajax({
                     url: 'https://vietnamtravel.net.vn/vi/gio-hang/470/ajax-them-san-pham.html',
                     method: "POST",
                     data: { "jsonInput" : jsonInput },
                     dataType: 'json',
                     beforeSend: function() {
                         elementError.addClass('show-error');
                         var imgloading = "<img alt="du lịch" src='https://vietnamtravel.net.vn/assets/desktop/images/ajax-loader.gif' width='125px'>";
                         elementError.children().html(imgloading);
                     },
                     success:function(result) {
                         if(result.status){
                             //window.location.href = result.hrefReload;
                             $('#totalCountCart').text(result.CartCount);
                             elementError.addClass('show-error');
                             elementError.children().text('Đã thêm vào giỏ hàng');
                         }
                     }
                 });
             });
      ...
      <script>
         $(document).ready(function(){
             $(".buy-booking-tour").click(function(e){
         var position = $(".b-detail-ct-tour").offset();
                 e.preventDefault();
         $("li#tit_tab_booking a").trigger("click");
                 //$("#profilebook").trigger("click");
               ...
               <div class="row">
                  <div class="col-md-12 col-xs-12 top-5">
                     <div class="cl-logo fl">
                        <h1 class="logo">
                           <a href="https://vietnamtravel.net.vn/vi/trang-chu.html"><img alt="du lịch" src="imgs/anhlogo.png" alt="logo"/></a>
                        </h1>
                     </div>
                     <div class="cl-bnt fl">
                        <div class="banner-top">
                           <a href="https://vietnamtravel.net.vn/vi/trang-chu.html"><img alt="du lịch" src="imgs/banner.png" alt="banner top"></a>
                        </div>
                     </div>
    ...
    <div class="bx-lang-rh">
      ...
      <div class="container-fluid">
         <div class="slider-wrapper theme-default">
            ...
            <a href="https://vietnamtravel.net.vn/vi/loai-tour/30-4/1.html"><img src="imgs/anh5.png" data-thumb="imgs/anh5.png" alt="aa" title="" /></a>
      ...
      <script type="text/javascript" src="https://vietnamtravel.net.vn/assets/desktop/plugin/Nivo-Slider-jQuery-master/jquery.nivo.slider.js"></script>
      <script type="text/javascript">
         ...
         <div class="row">
            <div class="col-md-12 col-xs-12 bx-title-lst-tour text-center">
               ...
               <div class="w100 fl title-tour1">
                  <h2 style="color: #ffc700; font-size:30px"><img src="imgs/icon_mb.png" alt="icon" style="width: 80px;">QUÝ KHÁCH CHỌN ĐỊA ĐIỂM DU LỊCH NÀO</h2>
               </div>
