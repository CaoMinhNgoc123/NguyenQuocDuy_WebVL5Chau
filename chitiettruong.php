...
,Tìm việc làm Nhân viên kinh doanh" />
   ...
   <body>
      ...
      <style>
       ...
       <h2 style = "text-align: center; color: blue; "> Danh Sách Các Trường Tại Tỉnh Gangwon  </h2>
...
<div style="margin-top: 40px;"> <strong> Nếu bạn đang băn khoăn không biết nên chọn trường nào ở Gangwon Hàn quốc thì chắc chắn không thể bỏ qua bài viết danh sách các trường tại tỉnh Gangwon dưới đây của Việc làm tại năm châu.</strong></div>
<div style="margin-top: 40px;">Nổi tiếng hàng đầu tại Hàn Quốc với nền kinh tế phát triển cùng môi trường học thuật chuyên sâu Gangwon là điểm đến lý tưởng của nhiều bạn trẻ muốn du học Hàn Quốc. Sau đây, Việc làm tại năm châu sẽ giới thiệu danh sách các trường ở Gangwon để bạn tham khảo và lựa chọn đúng trường với sở thích và tài chính của mình.</div>
<div class="content">
     
        <img src="imgs/anhtruong1.jpeg" alt="Ảnh minh họa">
          <img src="imgs/anhtruong2.jpeg" alt="Ảnh minh họa">
          <span style="textext-align:center;"> Danh Sách Các Trường  </span>
           <h1>Đại học Yonsei - tỉnh Gangwon</h1>
    <p><span class="highlight">Đại học Yonsei</span> là một trường đại học tư thục ở thủ đô Seoul, Hàn Quốc, được thành lập vào năm 1885, Yonsei là một trong những trường đại học lâu đời nhất của Hàn Quốc. Trường được đánh giá là một trong ba trường đại học tốt nhất của nước này cùng với Đại học Quốc gia Seoul và Đại học Hàn Quốc - tạo thành nhóm SKY.</p>
    <div class="university-info">
        <ul>
            <li><strong>Tên tiếng Anh:</strong> Yonsei University (Wonju Campus)</li>
            <li><strong>Tên tiếng Hàn:</strong> 연세대학교</li>
            <li><strong>Địa chỉ trường:</strong> 50 Yonsei-ro, Sinchon-dong, Seodaemun-gu, Seoul, Hàn Quốc</li>
            <li><strong>Loại hình:</strong> Tư thục</li>
            <li><strong>Điện thoại:</strong> +33-660-8034</li>
            <li><strong>Website:</strong> <a href="http://www.yonsei.ac.kr/eng/" target="_blank">http://www.yonsei.ac.kr/eng/</a></li>
            <li><strong>Học phí cho chương trình đại học:</strong> 3.657.000 – 7.230.000 KRW</li>
            <li><strong>Phí ký túc xá:</strong> 580.000 won/4 tháng</li>
        </ul>
    </div>
    </div>
...
<button class="dangky" > <i class="fa fa-paper-plane" aria-hidden="true"></i> Đăng ký đăng bài viết  </button>
